...
This plot also indicates a positive correlation between the average amount of gift and the number of clicks of repeat clickers than that of all clickers.
